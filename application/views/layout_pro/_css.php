...
<link href="<?php echo base_url('assets');?>/vendor/bootstrap-fileupload.min.css" rel="stylesheet">
<link href="<?php echo base_url('assets');?>/vendor/Raleway.css" rel="stylesheet">
